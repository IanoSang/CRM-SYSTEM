		...
		<div class="col-lg-6">
			...
			<div class="card-body contact text-center h-100 white-text">
				...
				<ul class="text-lg-left list-unstyled ml-4">
					...
					<br>
					<li>
						<p><i class="fas fa-envelope pr-2"></i>bormerconsult@gmail.com</p>
					</li>
					<br>
					<li>
			...
			<div class="row">
				<div class="col-lg-3">
					<div class="widget">
						...
						<i class="icon-envelope-alt"></i> bormerconsult@gmail.com
					</div>
				</div>
				<div class="col-lg-3">
					<div class="widget">
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-6">
						<div class="copyright">
							<p>
								<span>&copy; Bormer Consult 2022, All rights reserved. </span>
							</p>
						</div>
					</div>
					<div class="col-lg-6">
